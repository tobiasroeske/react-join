function Privacy() {
  ...
  return (
    <div className="special-page">
      ...
      <br />
      <p>
        Wir freuen uns über Ihr Interesse an unseren Dienstleistungen. Der
        Schutz Ihrer personenbezogenen Daten ist für uns ein wichtiges Anliegen.
        Nachfolgend möchten wir Sie daher über die Verarbeitung Ihrer Daten bei
        der Nutzung unserer Website informieren.{' '}
      </p>
      <br />
      ...
      <li>Tobias Roeske</li>
      <li>
        Email der Verantwortlichen: <b>info@tobias-roeske.com</b>
      </li>
      <li>
        Adresse der Verantwortlichen: <b>Straßbergerstraße 99, 80809 München</b>
      </li>
      <br />
      ...
      <p>
        ...
        Rechners, Name und URL der abgerufenen Datei, Website, von der aus der
        Zugriff erfolgt (Referrer-URL), Die Verarbeitung dieser Daten erfolgt
        gemäß Art. 6 Abs. 1 lit. f DSGVO auf Basis unseres berechtigten
        Interesses an der Gewährleistung der Sicherheit und Stabilität unserer
        Website. Bei Nutzung unseres Kontaktformulars Die Datenverarbeitung zum
        Zwecke der Kontaktaufnahme mit uns erfolgt gemäß Art. 6 Abs. 1 lit. a
        DSGVO auf Grundlage Ihrer freiwillig erteilten Einwilligung. Die für die
        Benutzung des Kontaktformulars von uns erhobenen personenbezogenen Daten
        werden nach Erledigung der von Ihnen gestellten Anfrage automatisch
        gelöscht.
      </p>
      <br />
      ...
      <p>
        ...
        Sie Auskunft über die Verarbeitungszwecke und ggf. aussagekräftigen
        Informationen zu deren Einzelheiten verlangen; gemäß Art. 16 DSGVO
        unverzüglich die Berichtigung unrichtiger oder Vervollständigung Ihrer
        bei uns gespeicherten personenbezogenen Daten zu verlangen; gemäß Art.
        17 DSGVO die Löschung Ihrer bei uns gespeicherten personenbezogenen
        ...
        erforderlich ist; gemäß Art. 18 DSGVO die Einschränkung der Verarbeitung

    ...
    return (
        <div className={styles.urgentTask} onClick={navigate}>
            ...
            <div className={styles.dueDateContainer}>
                <span className={styles.date}>October 10, 2022</span>

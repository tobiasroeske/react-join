    ...
    return (
      <div className={styles.taskDetailView}>
        <div className={styles.mainDetail}>
          ...
          <h2
            className={styles.taskDetailHeadline}
            style={task.title.length >= 32 ? { fontSize: '32px' } : {}}
          >
            {taskUpdate.title}
          </h2>
          ...
          <div className={styles.dateAndPrioContainer}>
            ...
            <span>
              {taskUpdate.priority}{' '}
              <img src={checkPriority(taskUpdate)} alt="" />
            </span>
          </div>
          ...
          <div className={styles.subtaskContainer}>
            Subtasks
            {taskUpdate.subtasks.length === 0 && <span>No subtasks</span>}

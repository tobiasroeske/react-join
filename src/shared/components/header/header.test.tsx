...
jest.mock('./profileDialogComponent', () => () => <div data-testid="profile-dialog">Profile Dialog</div>);
...
describe('Header', () => {
    ...
    test('should render the header with correct elements', () => {
        ...
        (useLocation as jest.Mock).mockReturnValue({ pathname: '/privacy-policy' } as any);
    ...
    test('Profile dialog is shown or hidden when profile initials are clicked', () => {
        ...
        let profileInitials = screen.getByTestId('profile-initials');
        let profileDialog = screen.queryByTestId('profile-dialog');

...
function ContactBar({onContactSelect, onShowPopup, contactDetailVisibility, showContact}: ContactBarProps) {
    return (
        <div className={styles.sidebar} style={contactDetailVisibility ? {} : {width: '100%'}}>

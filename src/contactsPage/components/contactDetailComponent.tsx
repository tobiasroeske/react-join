  ...
  return (
    <div className={classNames(styles.contactDetail)} onClick={handleClick}>
      <div className={styles.contactTop}>
        <div
          className={styles.initialsDetail}
          style={
            selectedContact ? { backgroundColor: selectedContact.color } : {}
          }
        >
          {initials}
        </div>
      ...
      <div
        className={classNames(styles.contactCreatedBox, {
          [styles.slideIn]: creationSuccessful
        })}
      >

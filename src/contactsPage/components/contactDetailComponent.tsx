...
import EditBtnMobile from './editButtonMobileComponent';
import { useState } from 'react';

type ContactDetailProps = {
    selectedContact: Contact | null,
    onEditContact: () => void,
    onSelectContact: (selectedContact: Contact | null) => void,
...
function ContactDetail({ selectedContact, onEditContact, onSelectContact, creationSuccessful }: ContactDetailProps) {
    const { deleteContact } = useFirestoreContext();
    const initials = useContactInitials(selectedContact);
    ...
    return (
        <div className={classNames(styles.contactDetail)} onClick={handleClick}>
            <div className={styles.contactTop}>
                ...
                <div className={styles.nameBox}>
                    ...
                    <div className={styles.editBox}>
                        ...
                        <span onClick={handleDelete}>{deleteSvg} Delete</span>
                    </div>
                </div>
            </div>
            ...
            <div className={classNames(styles.contactCreatedBox, { [styles.slideIn]: creationSuccessful })}>
                Contact successfully created
            </div>

            <EditBtnMobile showButton={showButton} setShowButton={setShowButton} editContact={onEditContact} onHandleDelete={handleDelete}/>
        </div>
    );
}

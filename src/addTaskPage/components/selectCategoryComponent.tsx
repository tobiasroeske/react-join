...
function SelectCategory({ onCategorySelect, selectedCategory, showDropdown, setShowDropdown }: SelectCategoryProps) {
            ...
            <div className="inputContainer">
                ...
                {showDropdown &&
                    <div className={classNames(styles.dropdownMenu, styles.category)}>
                        <div onClick={(e) => handleCategorySelect('Technical Task', e)}>Technical Task</div>
                        <div onClick={(e) => handleCategorySelect('User Story', e)} >User Story</div>
                    </div>}
            </div>
        </>
    );
